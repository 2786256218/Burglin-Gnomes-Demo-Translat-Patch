...
namespace GnomiumTranslation
{
    public static class TranslationCore
    {
        ...
        public static string Translate(string text)
        {
            ...
            } else if (noNewlineText.StartsWith("On cooldown ", StringComparison.OrdinalIgnoreCase)) {
                return "冷却中 " + noNewlineText.Substring(12).Trim();
